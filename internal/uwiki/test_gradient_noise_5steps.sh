...
#SBATCH --job-name=test-gradient-noise
...
# Run gradient noise experiment for 5 steps with evaluations
python -m pretrain_experiments config/unlearning-gradient-noise-179M.yaml \
    --training.num_steps 5 \
