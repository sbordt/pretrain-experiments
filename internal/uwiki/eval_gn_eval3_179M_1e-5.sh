...
#SBATCH --job-name=gn-eval3-179M-1e-5
...
# 546M gradient-noise unlearning variant (sigma=1e-5, run flvann74) at steps
...
# unlearning-gradient-noise/OLMo-2-179M-Exp-gradient-noise-flvann74/step<N>-hf.
# Outputs go to evals/gn-eval3-sweep/179M/1e-5/.
