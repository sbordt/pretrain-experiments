...
#SBATCH --job-name=gn-eval3-179M-1e-6
...
# 546M gradient-noise unlearning variant (sigma=1e-6, run h5p8rdiz) at steps
...
# unlearning-gradient-noise/OLMo-2-179M-Exp-gradient-noise-h5p8rdiz/step<N>-hf.
# Outputs go to evals/gn-eval3-sweep/179M/1e-6/.
