...
#SBATCH --job-name=gn-eval3-546M-1e-7
...
# 546M gradient-noise unlearning variant (sigma=1e-7, run dp69aj1f) at steps
...
# unlearning-gradient-noise/OLMo-2-546M-Exp-gradient-noise-dp69aj1f/step<N>-hf.
...
LABEL="1e-7"
RUN_DIR=~/pretrain-experiments/unlearning-gradient-noise/OLMo-2-546M-Exp-gradient-noise-dp69aj1f
