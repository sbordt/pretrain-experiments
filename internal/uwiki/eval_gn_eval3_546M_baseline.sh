...
#SBATCH --job-name=gn-eval3-546M-baseline
...
# Surgical re-eval: gaussian_watermark + memorization_patterns_mia only, for
# the 546M baseline (step100000-unsharded). Mirrors eval_gn_eval3_1B_baseline.sh
# scaled to the 546M paths used by eval_gn_eval3_sweep.sh.
#
# Outputs overwrite evals/gn-eval3-sweep/546M/baseline/step-100000/ (FK+VM
# outputs preserved; GW+MIA pre-cleaned before submission).
...
LABEL="baseline"
STEP="100000"
UNSHARDED=~/pretrain-experiments/checkpoints/546M-Exp-Unlearning/step100000-unsharded
HF_DIR=~/pretrain-experiments/checkpoints/546M-Exp-Unlearning/step100000-hf
...
echo ""
echo "============================================"
echo "  RESULTS SUMMARY  [$LABEL @ step $STEP, 546M]"
echo "============================================"
