...
#SBATCH --job-name=gn-eval3-179M-baseline
...
# the 179M baseline (step100000-unsharded). Mirrors eval_gn_eval3_1B_baseline.sh
# scaled to the 179M paths used by eval_gn_eval3_sweep.sh.
#
# Outputs overwrite evals/gn-eval3-sweep/179M/baseline/step-100000/ (FK+VM
...
LABEL="baseline"
STEP="100000"
UNSHARDED=~/pretrain-experiments/checkpoints/step100000-unsharded
HF_DIR=~/pretrain-experiments/checkpoints/step100000-hf
...
echo ""
echo "============================================"
echo "  RESULTS SUMMARY  [$LABEL @ step $STEP, 179M]"
echo "============================================"
