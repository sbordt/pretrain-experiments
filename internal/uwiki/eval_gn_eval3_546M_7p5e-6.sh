...
#SBATCH --job-name=gn-eval3-546M-7p5e-6
...
# 546M gradient-noise unlearning variant (sigma=7.5e-6, run 48sc3om3) at steps
# 102/104/106/108/110k. Mirrors eval_gn_eval3_1B_gn3p5e6.sh scaled to 546M.
#
# Local checkpoints (already converted to HF) live under
# unlearning-gradient-noise/OLMo-2-546M-Exp-gradient-noise-48sc3om3/step<N>-hf.
# Outputs go to evals/gn-eval3-sweep/546M/1e-7/.
...
LABEL="7.5e-6"
RUN_DIR=~/pretrain-experiments/unlearning-gradient-noise/OLMo-2-546M-Exp-gradient-noise-48sc3om3
