...
#SBATCH --job-name=gn-eval3-546M-5e-6
...
# 546M gradient-noise unlearning variant (sigma=5e-6, run ioza65lg) at steps
...
# unlearning-gradient-noise/OLMo-2-546M-Exp-gradient-noise-ioza65lg/step<N>-hf.
...
LABEL="5e-6"
RUN_DIR=~/pretrain-experiments/unlearning-gradient-noise/OLMo-2-546M-Exp-gradient-noise-ioza65lg
